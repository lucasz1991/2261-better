<div class="space-y-5">
    ...
    <section class="border-b border-slate-200 pb-5">
        <div class="flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
            <div class="min-w-0">
                <div class="inline-flex items-center gap-2 rounded-md border border-slate-200 bg-white px-3 py-1.5 text-xs font-semibold uppercase tracking-wide text-slate-600 shadow-sm">
                    <i class="fal fa-calendar-check text-blue-600"></i>
                    Bewertungsplanung
                </div>
                <h1 class="mt-3 text-2xl font-semibold tracking-tight text-slate-950">Geplante Bewertungen</h1>
                <p class="mt-1.5 max-w-3xl text-sm leading-6 text-slate-600">
                    Ueberblick ueber geplante Laeufe, AI-Vorbereitung, Score, Base-Verknuepfung und direkte Ausfuehrung.
                </p>
            </div>

            <div class="grid gap-2 sm:grid-cols-[minmax(0,1fr)_auto] xl:min-w-[520px]">
                <div class="rounded-lg border border-slate-200 bg-white px-4 py-3 shadow-sm">
                    <div class="flex items-center gap-3">
                        <span class="inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-md bg-blue-50 text-blue-700">
                            <i class="fal fa-clock"></i>
                        </span>
                        <div class="min-w-0">
                            <div class="text-xs font-semibold uppercase tracking-wide text-slate-500">Naechster Lauf</div>
                            <div class="mt-0.5 truncate text-sm font-semibold text-slate-950">{{ $nextScheduledLabel }}</div>
                        </div>
                    </div>
                </div>
                ...
                <button
                    ...
                    class="inline-flex items-center justify-center gap-2 rounded-lg border border-slate-300 bg-white px-4 py-3 text-sm font-medium text-slate-700 shadow-sm transition hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
                >
            ...
            <div class="rounded-lg border border-slate-200 bg-white px-3 py-3 shadow-sm">
                <div class="flex items-center justify-between gap-2">
                    <div class="min-w-0">
                        ...
                        <div class="mt-1 text-2xl font-semibold leading-none text-slate-950">{{ $kpi['value'] }}</div>
                    </div>
                    <span class="inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-md {{ $kpi['tone'] }}">
    ...
    <section class="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
        <div class="border-b border-slate-200 bg-slate-50/80 px-4 py-4">
            <div class="grid gap-4 xl:grid-cols-[minmax(0,1fr)_minmax(420px,520px)] xl:items-end">
                <div class="min-w-0">
                    ...
                    <p class="mt-1 text-sm text-slate-500">Zeile anklicken, um Antworten, Konfiguration und Benutzerdaten zu oeffnen.</p>
                </div>
                ...
                <div class="grid gap-2 sm:grid-cols-[minmax(0,1fr)_190px]">
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input
                                ...
                                class="block w-full rounded-lg border border-slate-300 bg-white py-2.5 pl-10 pr-3 text-sm shadow-sm focus:border-blue-500 focus:ring-blue-500"
                            >
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <select
                            ...
                            class="block w-full rounded-lg border border-slate-300 bg-white px-3 py-2.5 text-sm shadow-sm focus:border-blue-500 focus:ring-blue-500"
                        >
